...
//        Sprinkler sprinkler = new Sprinkler();
//
//        boolean[] expectedIsOn = new boolean[]{false, false, false, false, false, false, true,
//                true, true, true, false, false, false};
//
//        sprinkler.onTick();
//        sprinkler.addSchedule(new Schedule(1, 4));
//        sprinkler.addSchedule(new Schedule(2, 4));
//        sprinkler.addSchedule(new Schedule(3, 3));
//        sprinkler.addSchedule(new Schedule(7, 4));
//        for (int i = 0; i < expectedIsOn.length; ++i) {
//            assert (expectedIsOn[i] == sprinkler.isOn()) : i;
//            sprinkler.onTick();
//        }
